  ...
  render() {
    ...
    return (
      ...
      >
        ...
        />
        {/* make note the testID does not work on the page
            if the Error Text component does not pass onto the page
            the props it encounters ... May be an issue in other 
            projects were it will not find a testID that is 
            clearly on the component
            i.e. change component with the ...props like so
